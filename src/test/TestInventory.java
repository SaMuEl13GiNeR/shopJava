...
public class TestInventory {
	...
	public static void checkClass(Class<?> clazz) throws Throwable {
	...
	private static double testAddItem() throws Exception {
		double score = 0.0;
	...
	private static double testCheckStock() throws Exception {
		double score = 0.0;
	...
	private static double testRemoveItem() throws Throwable {
		double score = 0.0;
	...
	private static double testExtractItem() throws Exception {
		double score = 0.0;
