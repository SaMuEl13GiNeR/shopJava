...
public class TestSalesRegister {
    ...
    public static void checkSalesRegister() throws Exception {
    ...
    private static double testProcessSale() throws Exception {
        double score = 0.0;
    ...
    private static double testGetTotalSalesCount() throws Exception {
        double score = 0.0;
    ...
    private static double testGetTotalSalesAmount() throws Exception {
        double score = 0.0;
    ...
    private static double testGetBalance() throws Exception {
        double score = 0.0;
